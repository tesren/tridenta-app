<div>
    ...
    @section('titles')
        <title>{{__('Aviso de Privacidad - Tridenta Towers')}}</title>
    @endsection


    <section class="position-relative mb-6">

        <img src="{{asset('img/gallery-4.webp')}}" alt="Aviso de privacidad Tridenta Towers" class="w-100" style="height: 25vh; object-fit:cover; object-position:bottom;">
