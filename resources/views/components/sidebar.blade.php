...
<div class="d-none d-lg-flex flex-column flex-shrink-0 p-3 bg-darkblue w-100 h-100">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="{{route('dashboard.inventory.bay')}}" class="nav-link @if(Route::currentRouteName() == 'dashboard.inventory.bay') active @endif">
      ...
      @if (auth()->user()->role != 'client')
        <li>
          <a href="{{ url('nova/dashboards/main') }}" class="nav-link" target="_blank" rel="noopener noreferrer">
