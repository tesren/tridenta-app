{{-- Botón de WhatsApp --}}
<a id="whatsapp" href="https://wa.me/52{{config('domus.whatsapp_number')}}?text={{ urlencode(__('Hola, vengo del sitio web de Virēo Living')) }}" target="_blank" rel="noopener noreferrer"
