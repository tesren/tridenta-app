                ...
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            <svg width="18" height="auto" class="me-2" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fa-solid fa-heart me-2"></i>{{__('Favoritos')}}</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fa-solid fa-user me-2"></i>{{__('Mi Perfil')}}</a>
                    </li>
