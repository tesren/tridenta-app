        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body bg-darkblue position-relative">
                ...
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('dashboard.inventory.bay')}}">
                    ...
                    @if (auth()->user()->role != 'client')
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('nova/dashboards/main') }}"><i class="fa-solid fa-gauge-high me-2"></i>{{__('Admin Panel')}}</a>
                        </li>
                    @endif
