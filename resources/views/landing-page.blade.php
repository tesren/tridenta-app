...
@section('content')
  ...
  <div class="position-relative mb-6">
    ...
    <div class="row justify-content-center position-absolute top-0 left-0 h-100 z-3">
      <div class="col-11 col-lg-10 col-xl-8 text-center text-sand align-self-center">
          <img class="col-12 col-lg-7 col-xl-4" src="{{asset('img/vireo-bone-color.svg')}}" alt="Logo de Virēo Living">
          <h1 class="fs-2 mb-4">
            Condominios de 1, 2 y 3 recámaras <br> y 4 Villas Exclusivas<br>
            <span class="fs-5">Precios desde $7,400,000 MXN</span>
          </h1>
  ...
  <div class="row justify-content-evenly mb-6 text-center text-lg-start">
      ...
      <div class="col-12 col-lg-5 align-self-center">
          ...
          <p class="fw-light mb-4">Además, con superficies que van desde 80.76 m2 hasta 494.64 m2, encontrarás el espacio perfecto para ti y tu familia. </p>
  ...
  <div class="mb-6 text-center" id="contact">
